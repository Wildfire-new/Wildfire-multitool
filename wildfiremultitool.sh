...
coinname=wildfire
coinnamed=wildfired
coinnamecli=wildfire-cli
ticker=Wildfire
coindir=wildfire
binaries='https://github.com/Wildfire-new/Wildfire-MN-POW/releases/download/1.0.0/wildfired.zip'
snapshot='https://github.com/Wildfire-new/Wildfire-MN-POW/files/5683811/bootstrap.zip'
port=25572
rpcport=25571
discord='https://discord.gg/KUc4yMHAUr'
...
#Tools
    ...
    #Get check.sh
    wget https://github.com/Wildfire-new/WDF-multitool/blob/master/check.sh -O check.sh
    chmod +x check.sh
	#Enable IPv6
	sleep 2
...
ls /home
echo "Above are the alias names for installed MN's"
echo -e '\e[4mPlease enter MN alias. Example wildfiremn3\e[24m'
...
echo "addnode=144.91.90.160" >> $coinname.conf
echo "addnode=207.180.193.26" >> $coinname.conf
